    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bedroom', models.CharField(blank=True, default=0, max_length=32, null=True)),
                ('bathroom', models.CharField(blank=True, default=0, max_length=32, null=True)),
                ('car_bikes', models.CharField(blank=True, default=0, max_length=32, null=True)),
                ('pets_allow', models.CharField(blank=True, default=0, max_length=32, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Kitchen',
